...
def move(my_history, their_history, my_score, their_score):
    ...
    if len(my_history)==0: #It's the first round; collude.
        return 'c'
    elif my_history[-1]=='c' and their_history[-1]=='b': #If my history is c and their history is b, then return with b. 
        return 'b' 
    else:
        return 'c' #Otherwises return c.      
    #Scenario #2: First Turn Betray
    if len(my_history)==0: #It's the first round; betray.
        return 'b'
    elif my_history[-1]=='b' and their_history[-1]=='c': #If my history is b and their history is c, then return with c. 
        return 'c' 
    else:
        return 'b' #Overwise return b. 
